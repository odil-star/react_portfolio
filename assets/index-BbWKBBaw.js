...
` + e.stack
    ...
    function rn(e, t, n) {
      ...
      if (e = e.style, n != null) {
        ...
        for (var a in t) t.hasOwnProperty(a) && nn(e, a, t[a])
    }
    ...
    function Wo(e, t, n) {
      ...
      if (o && (i.memoizedState = n, z = !0), i = i.queue, hs(qo.bind(null, r, i, e), [e]), i.getSnapshot !== t || o || I !== null && I.memoizedState.tag & 1) {
        if (r.flags |= 2048, us(9, {
            destroy: void 0
          }, Ko.bind(null, r, i, n, t), null), G === null) throw Error(s(349));
        a || yo & 127 || Go(r, t, n)
      }
      return n
    }
    ...
    var Ws = {
        ...
        useSyncExternalStore: function (e, t, n) {
          ...
          return i.queue = a, ms(qo.bind(null, r, a, e), [e]), r.flags |= 2048, us(9, {
            destroy: void 0
          }, Ko.bind(null, r, a, n, t), null), n
        },
        useId: function () {
          var e = Fo(),
    ...
    function oc(e, t, n, r, i) {
      ...
      if (j) return t = uo.current, t === null ? (r !== Gi && (t = Error(s(423), {
        cause: r
      }), Qi(Di(t, n))), e = e.current.alternate, e.flags |= 65536, i &= -i, e.lanes |= i, r = Di(r, n), i = rc(e.stateNode, r, i), $a(e, i), Y !== 4 && (Y = 2)) : (!(t.flags & 65536) && (t.flags |= 256), t.flags |= 65536, t.lanes = i, r !== Gi && (e = Error(s(422), {
        cause: r
      }), Qi(Di(e, n)))), !1;
      var a = Error(s(520), {
        cause: r
    ...
    function wd(e, t, n, r, i) {
      ...
      gn(function () {
        ...
        if (!(t & 7)) {
          ...
          else lr ? sr(e, n) && (x = `onCompositionEnd`) : e === `keydown` && n.keyCode === 229 && (x = `onCompositionStart`);x && (ir && n.locale !== `ko` && (lr || x !== `onCompositionStart` ? x === `onCompositionEnd` && lr && (b = wn()) : (xn = i, Sn = `value` in xn ? xn.value : xn.textContent, lr = !0)), y = Ed(r, x), 0 < y.length && (x = new Hn(x, e, null, n, i), o.push({
            event: x,
            listeners: y
          }), b ? x.data = b : (b = cr(n), b !== null && (x.data = b)))),
          (b = rr ? ur(e, n) : dr(e, n)) && (x = Ed(r, `onBeforeInput`), 0 < x.length && (y = new Hn(`onBeforeInput`, `beforeinput`, null, n, i), o.push({
            event: y,
            listeners: x
          }), y.data = b)),
          md(o, e, r, n, i)
...
function h({
  ...
  let [t, n] = (0, l.useState)(`ru`), r = (0, l.useMemo)(() => ({
    language: t,
    setLanguage: n,
    languages: d
  }), [t]);
...
var _ = {
  ru: {
    header: {
      tagline: `IT studio • web development`,
    ...
    hero: {
      kicker: `HTML • CSS • JavaScript • React`,
      title: `IT-портфолио и разработка сайтов в стиле современного digital-продукта.`,
      text: `Делаю лендинги, сайты-визитки, корпоративные проекты, интернет-магазины и React-интерфейсы. Визуал ближе к технологичным студиям: чистая типографика, акцентные блоки, анимации и адаптив под любое устройство.`,
      primary: `Смотреть портфолио`,
      secondary: `Обсудить проект`,
      tags: [`Адаптивная верстка`, `Продуманная структура`, `Форма обратной связи`],
      panelLabel: `Фокус`,
      panelText: `Сайт должен выглядеть технологично и приносить заявки, а не просто занимать домен.`,
      metrics: [{
        value: `Landing`,
        label: `быстрые продающие страницы`
      }, {
        value: `React`,
        label: `интерфейсы для роста продукта`
      }, {
        value: `E-commerce`,
        label: `магазины и каталоги`
      }]
    },
    services: {
      kicker: `Услуги`,
      title: `Разработка от простого лендинга до сложного продуктового интерфейса`,
      text: `Подбираю формат под задачу бизнеса: от быстрой презентации услуги до интерфейса, который можно масштабировать и развивать дальше.`,
      items: [{
        title: `Лендинги и визитки`,
        description: `Быстрые сайты для презентации услуги, запуска рекламы и сбора заявок.`
      }, {
        title: `Корпоративные сайты`,
        description: `Многостраничные проекты с услугами, кейсами, формами и сильной подачей бренда.`
      }, {
        title: `Интернет-магазины`,
        description: `Каталог, карточки товаров, корзина, фильтры и логика для удобной покупки.`
      }, {
        title: `React-приложения`,
        description: `Интерактивные интерфейсы, кабинеты, панели управления и продуктовые сервисы.`
      }]
    },
    portfolio: {
      kicker: `Портфолио`,
      title: `Визуальный стиль ближе к IT-продуктам, студиям и современным веб-сервисам`,
      text: `Ниже примеры направлений, в которых можно собирать проекты: минималистично, технологично и с акцентом на пользовательский сценарий.`,
      items: [{
        title: `FinFlow Landing`,
        type: `Лендинг / SaaS`,
        description: `Технологичный лендинг для digital-сервиса с сильным hero-блоком, преимуществами и цепочкой CTA.`
      }, {
        title: `Nova Store`,
        type: `E-commerce`,
        description: `Интернет-магазин с каталогом, карточками товаров, корзиной и интерфейсом для роста продаж.`
      }, {
        title: `Control Desk`,
        type: `React Dashboard`,
        description: `Панель управления для сервиса с виджетами, ролями пользователей и чистой навигацией.`
      }]
    },
    process: {
      kicker: `Этапы`,
      title: `Прозрачный процесс разработки без перегруза и хаоса`,
      text: `Каждый этап понятен: от идеи до работающего сайта с готовой формой обратной связи.`,
      steps: [`Созваниваемся или переписываемся, чтобы понять задачу и формат сайта.`, `Собираем структуру, контентные блоки и визуальное направление.`, `Разрабатываем адаптивный интерфейс, добавляем анимации и нужную логику.`, `Подключаем форму, проверяем работу сайта и готовим проект к запуску.`]
    },
    contact: {
      kicker: `Обратная связь`,
      title: `Оставьте заявку и расскажите, какой сайт или интерфейс вам нужен`,
      text: `Форма уже подключена к вашему API. Можно отправлять заявки на лендинг, визитку, корпоративный сайт, интернет-магазин или React-проект.`,
      points: [{
        title: `Фронтенд`,
        text: `HTML, SCSS, JavaScript, React`
      }, {
        title: `Формат`,
        text: `Под ключ, с адаптивом и анимациями`
      }],
      form: {
        name: `Ваше имя`,
        phone: `Телефон`,
        service: `Тип проекта`,
        message: `Комментарий`,
        namePlaceholder: `Например, Одил`,
        phonePlaceholder: `+998 90 123 45 67`,
        messagePlaceholder: `Коротко опишите задачу, стиль и пожелания`,
        servicePlaceholder: `Выберите услугу`,
        services: [`Лендинг`, `Сайт-визитка`, `Корпоративный сайт`, `Интернет-магазин`, `React-приложение`],
        submit: `Отправить заявку`,
        submitting: `Отправка...`,
        success: `Заявка отправлена. Скоро свяжусь с вами.`,
        error: `Ошибка при отправке формы.`
      }
    },
    footer: {
      title: `Разработка сайтов и интерфейсов для бизнеса`,
      services: `Услуги`,
      portfolio: `Портфолио`,
      contact: `Связаться`
    }
  ...
  uz: {
    header: {
      tagline: `IT studio • veb dasturlash`,
    ...
    hero: {
      kicker: `HTML • CSS • JavaScript • React`,
      title: `Zamonaviy digital mahsulot uslubidagi IT-portfolio va sayt ishlab chiqish.`,
      text: `Landing, vizitka saytlar, korporativ loyihalar, internet-do‘konlar va React interfeyslar yarataman. Vizual uslub texnologik studiyalarga yaqin: toza tipografiya, urg‘uli bloklar, animatsiyalar va har qanday qurilmaga moslashuv.`,
      primary: `Portfolio ko‘rish`,
      secondary: `Loyihani muhokama qilish`,
      tags: [`Moslashuvchan verstka`, `O‘ylangan struktura`, `Qayta aloqa formasi`],
      panelLabel: `Fokus`,
      panelText: `Sayt texnologik ko‘rinishi va murojaatlar olib kelishi kerak, shunchaki domenni egallab turmasligi kerak.`,
      metrics: [{
        value: `Landing`,
        label: `tezkor sotuvchi sahifalar`
      }, {
        value: `React`,
        label: `mahsulot o‘sishi uchun interfeyslar`
      }, {
        value: `E-commerce`,
        label: `do‘konlar va kataloglar`
      }]
    },
    services: {
      kicker: `Xizmatlar`,
      title: `Oddiy lendingdan murakkab mahsulot interfeyslarigacha ishlab chiqish`,
      text: `Biznes vazifasiga mos format tanlayman: xizmatni tez taqdim etishdan boshlab, keyinchalik kengaytirish mumkin bo‘lgan interfeysgacha.`,
      items: [{
        title: `Lending va vizitkalar`,
        description: `Xizmatni tanishtirish, reklama ishga tushirish va so‘rov yig‘ish uchun tezkor saytlar.`
      }, {
        title: `Korporativ saytlar`,
        description: `Xizmatlar, кейсlar, formalar va kuchli brend taqdimoti bilan ko‘p sahifali loyihalar.`
      }, {
        title: `Internet-do‘konlar`,
        description: `Katalog, mahsulot kartalari, savat, filtrlash va qulay xarid logikasi.`
      }, {
        title: `React ilovalar`,
        description: `Interaktiv interfeyslar, kabinetlar, boshqaruv panellari va mahsulot servislar.`
      }]
    },
    portfolio: {
      kicker: `Portfolio`,
      title: `Vizual uslub IT-mahsulotlar, studiyalar va zamonaviy veb-servislarga yaqin`,
      text: `Quyida loyihalarni qanday yo‘nalishda yig‘ish mumkinligi ko‘rsatilgan: minimalistik, texnologik va foydalanuvchi ssenariysiga urg‘u bilan.`,
      items: [{
        title: `FinFlow Landing`,
        type: `Lending / SaaS`,
        description: `Digital servis uchun kuchli hero-blok, afzalliklar va CTA zanjiri bilan texnologik lending.`
      }, {
        title: `Nova Store`,
        type: `E-commerce`,
        description: `Katalog, mahsulot kartalari, savat va savdoni oshirish uchun interfeysga ega internet-do‘kon.`
      }, {
        title: `Control Desk`,
        type: `React Dashboard`,
        description: `Widgetlar, foydalanuvchi rollari va toza navigatsiyaga ega boshqaruv paneli.`
      }]
    },
    process: {
      kicker: `Bosqichlar`,
      title: `Ortiqcha chalkashliksiz tushunarli ishlab chiqish jarayoni`,
      text: `Har bir bosqich aniq: g‘oyadan tayyor aloqa formasi bo‘lgan ishlaydigan saytga qadar.`,
      steps: [`Loyiha vazifasi va sayt formatini tushunish uchun qo‘ng‘iroq qilamiz yoki yozishamiz.`, `Struktura, kontent bloklari va vizual yo‘nalishni yig‘amiz.`, `Moslashuvchan interfeys yaratamiz, animatsiyalar va kerakli logikani qo‘shamiz.`, `Formani ulaymiz, sayt ishini tekshiramiz va loyihani ishga tushirishga tayyorlaymiz.`]
    },
    contact: {
      kicker: `Qayta aloqa`,
      title: `So‘rov qoldiring va qanday sayt yoki interfeys kerakligini yozing`,
      text: `Forma sizning API’ngizga ulangan. Lending, vizitka, korporativ sayt, internet-do‘kon yoki React loyiha uchun so‘rov yuborish mumkin.`,
      points: [{
        title: `Frontend`,
        text: `HTML, SCSS, JavaScript, React`
      }, {
        title: `Format`,
        text: `Kalit topshirish asosida, adaptiv va animatsiyalar bilan`
      }],
      form: {
        name: `Ismingiz`,
        phone: `Telefon`,
        service: `Loyiha turi`,
        message: `Izoh`,
        namePlaceholder: `Masalan, Odil`,
        phonePlaceholder: `+998 90 123 45 67`,
        messagePlaceholder: `Vazifa, uslub va istaklarni qisqacha yozing`,
        servicePlaceholder: `Xizmatni tanlang`,
        services: [`Lending`, `Vizitka sayt`, `Korporativ sayt`, `Internet-do‘kon`, `React ilova`],
        submit: `So‘rov yuborish`,
        submitting: `Yuborilmoqda...`,
        success: `So‘rov yuborildi. Tez orada siz bilan bog‘lanaman.`,
        error: `Formani yuborishda xatolik.`
      }
    },
    footer: {
      title: `Biznes uchun saytlar va interfeyslar ishlab chiqish`,
      services: `Xizmatlar`,
      portfolio: `Portfolio`,
      contact: `Bog‘lanish`
    }
  ...
  en: {
    ...
    hero: {
      kicker: `HTML • CSS • JavaScript • React`,
      title: `IT portfolio and website development in a modern digital product style.`,
      text: `I build landing pages, portfolio sites, corporate websites, online stores, and React interfaces. The visual style is closer to product studios: clean typography, bold blocks, motion, and full responsiveness for any device.`,
      primary: `View portfolio`,
      secondary: `Discuss project`,
      tags: [`Responsive layout`, `Clear structure`, `Contact form`],
      panelLabel: `Focus`,
      panelText: `A website should look technological and generate leads, not just occupy a domain name.`,
      metrics: [{
        value: `Landing`,
        label: `fast conversion-focused pages`
      }, {
        value: `React`,
        label: `interfaces for product growth`
      }, {
        value: `E-commerce`,
        label: `stores and catalogs`
      }]
    },
    services: {
      kicker: `Services`,
      title: `Development from a simple landing page to a complex product interface`,
      text: `I choose the right format for the business goal: from a fast service presentation to an interface that can scale over time.`,
      items: [{
        title: `Landing pages and one-pagers`,
        description: `Fast websites for presenting a service, launching ads, and collecting leads.`
      }, {
        title: `Corporate websites`,
        description: `Multi-page projects with services, cases, forms, and a strong brand presentation.`
      }, {
        title: `Online stores`,
        description: `Catalog, product cards, cart, filters, and logic for a smooth buying experience.`
      }, {
        title: `React applications`,
        description: `Interactive interfaces, dashboards, user areas, and product services.`
      }]
    },
    portfolio: {
      kicker: `Portfolio`,
      title: `A visual direction inspired by IT products, studios, and modern web services`,
      text: `Here are sample directions for the type of projects we can build: minimal, technological, and focused on user flow.`,
      items: [{
        title: `FinFlow Landing`,
        type: `Landing / SaaS`,
        description: `A technology-driven landing page for a digital service with a strong hero section and CTA flow.`
      }, {
        title: `Nova Store`,
        type: `E-commerce`,
        description: `An online store with catalog, product cards, cart, and an interface designed to grow sales.`
      }, {
        title: `Control Desk`,
        type: `React Dashboard`,
        description: `A dashboard for a service with widgets, user roles, and clean navigation.`
      }]
    },
    process: {
      kicker: `Process`,
      title: `A clear development flow without chaos or overload`,
      text: `Every stage is transparent: from idea to a working website with a ready contact form.`,
      steps: [`We talk or chat to understand the goal and website format.`, `We define the structure, content blocks, and visual direction.`, `I build the responsive interface and add motion plus required logic.`, `I connect the form, test the website, and prepare the project for launch.`]
    },
    contact: {
      kicker: `Contact`,
      title: `Leave a request and describe the website or interface you need`,
      text: `The form is already connected to your API. You can send requests for a landing page, business card site, corporate website, online store, or React project.`,
      points: [{
        title: `Frontend`,
        text: `HTML, SCSS, JavaScript, React`
      }, {
        title: `Format`,
        text: `Turnkey work with responsiveness and animations`
      }],
      form: {
        name: `Your name`,
        phone: `Phone`,
        ...
        message: `Comment`,
        namePlaceholder: `For example, Odil`,
        phonePlaceholder: `+998 90 123 45 67`,
        messagePlaceholder: `Briefly describe the task, style, and wishes`,
        servicePlaceholder: `Choose a service`,
        services: [`Landing page`, `Business card site`, `Corporate website`, `Online store`, `React application`],
        submit: `Send request`,
        submitting: `Sending...`,
        success: `Request sent. I will contact you soon.`,
        error: `Failed to submit the form.`
      }
    },
    footer: {
      title: `Website and interface development for business`,
      services: `Services`,
      portfolio: `Portfolio`,
      contact: `Contact`
    }
    ...
    children: (0, p.jsxs)(`div`, {
      ...
      children: [(0, p.jsxs)(`a`, {
        ...
        children: [(0, p.jsxs)(`nav`, {
          className: `site-nav`,
          "aria-label": r.navLabel,
          children: [(0, p.jsx)(`a`, {
            className: `site-nav__link`,
            href: `#services`,
            children: r.nav.services
          }), (0, p.jsx)(`a`, {
            className: `site-nav__link`,
            href: `#portfolio`,
            children: r.nav.portfolio
          }), (0, p.jsx)(`a`, {
            className: `site-nav__link`,
            href: `#process`,
            children: r.nav.process
          }), (0, p.jsx)(`a`, {
            className: `site-nav__link`,
            href: `#contact`,
            children: r.nav.contact
          })]
        }), (0, p.jsxs)(`div`, {
          ...
          children: [(0, p.jsx)(`span`, {
            ...
            "aria-hidden": `true`
          }), n.map(n => (0, p.jsx)(`button`, {
            type: `button`,
            className: `language-switch__button ${e===n.code?`is-active`:``}`,
            onClick: () => t(n.code),
...
function y() {
  ...
  return (0, p.jsx)(`section`, {
    ...
    id: `hero`,
    children: (0, p.jsxs)(`div`, {
      className: `container hero-section__grid`,
      children: [(0, p.jsxs)(`div`, {
        className: `hero-copy`,
        children: [(0, p.jsx)(`p`, {
          ...
          className: `hero-copy__tags`,
          "aria-label": t.panelLabel,
          children: t.tags.map(e => (0, p.jsx)(`li`, {
            children: e
          }, e))
        })]
      }), (0, p.jsxs)(`div`, {
        ...
        children: [(0, p.jsxs)(`div`, {
          className: `hero-showcase__panel hero-showcase__panel--primary`,
          children: [(0, p.jsx)(`span`, {
            children: t.panelLabel
          }), (0, p.jsx)(`strong`, {
            children: t.panelText
          })]
        }), (0, p.jsxs)(`div`, {
          className: `hero-showcase__code`,
          children: [(0, p.jsxs)(`div`, {
            className: `hero-showcase__code-head`,
            children: [(0, p.jsx)(`span`, {}), (0, p.jsx)(`span`, {}), (0, p.jsx)(`span`, {})]
          }), (0, p.jsx)(`pre`, {
            children: `const stack = ['HTML', 'SCSS', 'JavaScript', 'React']
...
launchProject({
  ...
  conversionFocused: true,
          ...
          className: `hero-showcase__metrics`,
          children: t.metrics.map(e => (0, p.jsxs)(`article`, {
            children: [(0, p.jsx)(`strong`, {
              children: e.value
            }), (0, p.jsx)(`p`, {
              children: e.label
  ...
  return (0, p.jsx)(`section`, {
    ...
    children: (0, p.jsxs)(`div`, {
      ...
      children: [(0, p.jsxs)(`div`, {
        ...
        children: t.items.map(e => (0, p.jsxs)(`article`, {
  ...
  return (0, p.jsx)(`section`, {
    ...
    children: (0, p.jsxs)(`div`, {
      ...
      children: [(0, p.jsxs)(`div`, {
        ...
        children: t.items.map((e, t) => (0, p.jsxs)(`article`, {
          className: `portfolio-card`,
          children: [(0, p.jsxs)(`div`, {
            className: `portfolio-card__preview`,
            children: [(0, p.jsx)(`span`, {
              className: `portfolio-card__badge`,
              children: e.type
            }), (0, p.jsxs)(`div`, {
              className: `portfolio-card__screen portfolio-card__screen--${t+1}`,
              children: [(0, p.jsx)(`span`, {
                className: `portfolio-card__line`
              }), (0, p.jsx)(`span`, {
                className: `portfolio-card__line portfolio-card__line--short`
              }), (0, p.jsxs)(`div`, {
                className: `portfolio-card__widgets`,
                children: [(0, p.jsx)(`span`, {}), (0, p.jsx)(`span`, {}), (0, p.jsx)(`span`, {})]
              })]
            })]
          }), (0, p.jsxs)(`div`, {
            className: `portfolio-card__content`,
            children: [(0, p.jsx)(`h3`, {
              children: e.title
            }), (0, p.jsx)(`p`, {
              children: e.description
...
function ee() {
  ...
  return (0, p.jsx)(`section`, {
    ...
    id: `process`,
    children: (0, p.jsxs)(`div`, {
      className: `container process-layout`,
      children: [(0, p.jsxs)(`div`, {
        ...
        children: t.steps.map((e, t) => (0, p.jsxs)(`article`, {
          className: `process-item`,
          children: [(0, p.jsxs)(`span`, {
            className: `process-item__index`,
            children: [`0`, t + 1]
          }), (0, p.jsx)(`p`, {
            children: e
          })]
...
var S = `https://script.google.com/macros/s/AKfycbxJRgt75-MJ9LcTOIcqK-AzdzZyXS-yIdyc5DA79rn9cydI3AuvJ2GA3mVrKtXG4aYU/exec`;
async function C(e) {
  let t = await fetch(S, {
      method: `POST`,
    ...
    n = await t.json();
  if (!t.ok || !n.success) throw Error(n.message || `Не удалось отправить заявку.`);
  return n
}
  ...
  return (0, p.jsxs)(`label`, {
    ...
    children: [(0, p.jsx)(`span`, {
      ...
      children: [(0, p.jsx)(`option`, {
        value: ``,
        disabled: !0,
        children: r.servicePlaceholder
      }), r.services.map(e => (0, p.jsx)(`option`, {
        value: e,
        children: e
      }, e))]
    })]
...
function re() {
  let {
    language: e
  } = g(), t = _[e].contact.form, [n, r] = (0, l.useState)(ne), [i, a] = (0, l.useState)({
    type: ``,
    message: ``
  }), [o, s] = (0, l.useState)(!1), c = e => {
    let {
      name: t,
      value: n
    } = e.target;
  ...
  return (0, p.jsxs)(`form`, {
    ...
    children: [(0, p.jsxs)(`div`, {
      ...
      className: `contact-form__footer`,
      children: [(0, p.jsx)(`button`, {
        className: `button button--primary`,
        type: `submit`,
        disabled: o,
        children: o ? t.submitting : t.submit
      }), i.message ? (0, p.jsx)(`p`, {
        className: `contact-form__status contact-form__status--${i.type}`,
        children: i.message
      }) : null]
    })]
  })
    ...
    children: (0, p.jsxs)(`div`, {
      ...
      children: [(0, p.jsxs)(`div`, {
        ...
        children: [(0, p.jsx)(`p`, {
          ...
          className: `contact-section__points`,
          children: t.points.map(e => (0, p.jsxs)(`div`, {
            children: [(0, p.jsx)(`strong`, {
              children: e.title
            }), (0, p.jsx)(`span`, {
              children: e.text
...
function ae() {
  return (0, p.jsxs)(`div`, {
    ...
    children: [(0, p.jsx)(v, {}), (0, p.jsxs)(`main`, {
      children: [(0, p.jsx)(y, {}), (0, p.jsx)(b, {}), (0, p.jsx)(x, {}), (0, p.jsx)(ee, {}), (0, p.jsx)(w, {})]
    }), (0, p.jsx)(ie, {})]
  })
}(0, u.createRoot)(document.getElementById(`root`)).render((0, p.jsx)(l.StrictMode, {
  children: (0, p.jsx)(h, {
    children: (0, p.jsx)(ae, {})
  })
}));